/*
  ...
  - You are about to drop the column `buy_date` on the `tickets` table. All the data in the column will be lost.
...
INSERT INTO "new_events" ("capacity", "category_id", "created_at", "deleted_at", "description", "id", "location", "name", "photo", "start_date", "updated_at", "user_id") SELECT "capacity", "category_id", "created_at", "deleted_at", "description", "id", "location", "name", "photo", "start_date", "updated_at", "user_id" FROM "events";
DROP TABLE "events";
